...
// //       // Get current user from session storage (already set during login)
...
// //       // Build HTML for user info toast
// //       toastContent.innerHTML = `
// //         <i class="fas fa-user-circle toast-icon"></i>
...
// //       // Apply styles for a larger toast
// //       toast.style.width = 'auto';
// //       toast.style.maxWidth = '300px';
// //       toast.classList.add('show');
      
// //       // Hide toast after 5 seconds (longer duration for reading)
// //       setTimeout(() => {
// //         toast.classList.remove('show');
// //         // Reset toast to default styling after hiding
// //         setTimeout(() => {
// //           toast.style.width = '';
...
//       // Create a custom toast with more details and a password update option
//       const toast = document.getElementById('toast');
//       const toastContent = document.querySelector('.toast-content');
      
//       // Build HTML for user info toast with password update button
//       toastContent.innerHTML = `
//         <div class="toast-message">
//           <div><strong>Name:</strong> ${currentUser.name}</div>
//           <div><strong>Email:</strong> ${currentUser.email}</div>
...
//       // Apply styles for a larger toast and center it
...
//       // Hide toast after 10 seconds (longer duration for reading)
//       setTimeout(() => {
//         toast.classList.remove('show');
//         // Reset toast to default styling after hiding
//         setTimeout(() => {
...
//     // Create a modal for password update
//     const modalHTML = `
...
//       // Here you would normally verify the current password against stored password
//       // and update the password in your database/storage
      
//       // For now, just update the password in session storage
